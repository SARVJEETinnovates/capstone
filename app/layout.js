  ...
  return (
    <html lang="en">
      <body>
        ...
        {/* Navbar */}
        <nav className="bg-blue-600 flex h-15 text-black gap-8 justify-around items-center drop-shadow-black">
          <div>
            <h1 className="font-bold text-4xl text-yellow-400"> Health Icon</h1>
          </div> 
          <div className="flex gap-10 items-center">
            <div className="flex gap-6 text-gray-600 font-light text-[15px]">
              <Link href='./'>
                <span className="text-white hover:text-yellow-500">Home</span>
              </Link>
              <Link href='./service'>
                <span className="text-white hover:text-yellow-500">Service</span>
              </Link>
              <Link href='./aboutUs'>
                <span className="text-white hover:text-yellow-500">About Us</span>
              </Link>
              <Link href='./contactUs'>
                <span className="text-white hover:text-yellow-500">Contact Us</span>
              </Link>
            </div>
            <div className="pl-10 flex gap-3">
              <Button variant='outline' className="  text-yellow-500 hover:text-xl gray">Register</Button>
              <Button variant='outline' className=" text-yellow-500 hover:text-xl gray">Login</Button>
            </div>
          </div>
        </nav>
